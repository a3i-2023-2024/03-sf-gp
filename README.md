...
This tutorial in particular tackles methods for filling missing values in time series, starting with simple heuristic approaches (e.g. forward/backward filling and linear interpolation), and ending with the use of Gaussian Processes.
...
```sh
git clone https://github.com/a3i-2023-2024/03-sf-gp.git
```
